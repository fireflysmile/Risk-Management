...
import { ModalBackgroundComponent } from '@components/modal/modal-background/modal-background.component';
import { ModalContentWrapperComponent } from '@components/modal/modal-content-wrapper/modal-content-wrapper.component';
